#!/usr/bin/env python3
"""Snowflake stats helper.

Parses Snowflake proxy docker logs for the selected window and prints:
- Connections
- Down / Up totals (GB)
- Down:Up ratio

No hostnames, fingerprints, or operator identifiers are required.
"""
